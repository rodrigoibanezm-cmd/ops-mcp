...
export const vercelTools = [
  ...
  {
    name: 'vercel.env.set',
    description: 'Crea una variable de entorno nueva en Vercel. Requiere write_token.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Actualiza una variable existente en Vercel usando env_id. Requiere write_token.',
    inputSchema: {
      type: 'object',
      properties: {
        project_key: { type: 'string' },
